...
const ReservationMonitor = ({ isOpen, onClose }) => {
  ...
  // Dummy reservation data - 20 rows with updated structure (including voucher numbers)
  const allReservations = [
    { id: 'res-001', date: '15.01.2025', sourceAgency: 'THV', agency: 'Skyline Tours', passenger: 'John Smith', hotel: 'Grand Seaside Hotel', stars: 5, destination: 'Antalya', checkIn: '2025-01-15', checkOut: '2025-01-22', nights: 7, room: 'Deluxe', board: 'All Inclusive', paxAdults: 2, paxChildren: 0, paxInfants: 0, status: 'CONFIRMED', voucherNo: 'THV-2025-001' },
    ...
    { id: 'res-003', date: '18.01.2025', sourceAgency: 'SELECT HOLIDAYS', agency: 'Golden Tours', passenger: 'Michael Brown', hotel: 'Istanbul Palace Hotel', stars: 5, destination: 'İstanbul', checkIn: '2025-01-18', checkOut: '2025-01-25', nights: 7, room: 'Suite', board: 'Breakfast', paxAdults: 2, paxChildren: 0, paxInfants: 0, status: 'CONFIRMED', voucherNo: 'SEL-2025-078' },
    { id: 'res-004', date: '20.01.2025', sourceAgency: 'AZURO', agency: 'Sunrise Travel', passenger: 'Sarah Davis', hotel: 'Fethiye Beach Resort', stars: 4, destination: 'Fethiye', checkIn: '2025-01-20', checkOut: '2025-01-27', nights: 7, room: 'Family Room', board: 'All Inclusive', paxAdults: 2, paxChildren: 3, paxInfants: 0, status: 'CONFIRMED', voucherNo: 'AZU-2025-223' },
    { id: 'res-005', date: '17.01.2025', sourceAgency: 'THV', agency: 'Dream Holidays', passenger: 'David Wilson', hotel: 'Marmaris Bay Hotel', stars: 3, destination: 'Marmaris', checkIn: '2025-01-17', checkOut: '2025-01-24', nights: 7, room: 'Standard', board: 'Full Board', paxAdults: 2, paxChildren: 0, paxInfants: 0, status: 'CANCELLED', voucherNo: 'THV-2025-019' },
    ...
    { id: 'res-007', date: '21.01.2025', sourceAgency: 'SELECT HOLIDAYS', agency: 'Ocean View Travel', passenger: 'Robert Taylor', hotel: 'Çeşme Grand Resort', stars: 5, destination: 'Çeşme', checkIn: '2025-01-21', checkOut: '2025-01-28', nights: 7, room: 'Superior', board: 'Half Board', paxAdults: 2, paxChildren: 0, paxInfants: 0, status: 'OPTION', voucherNo: 'SEL-2025-091' },
    ...
    { id: 'res-010', date: '18.01.2025', sourceAgency: 'EURO TOURS', agency: 'Elite Holidays', passenger: 'Mary Rodriguez', hotel: 'Side Star Resort', stars: 4, destination: 'Side', checkIn: '2025-01-18', checkOut: '2025-01-25', nights: 7, room: 'Deluxe', board: 'Full Board', paxAdults: 2, paxChildren: 2, paxInfants: 0, status: 'OPTION', voucherNo: 'EUR-2025-167' },
    { id: 'res-011', date: '20.01.2025', sourceAgency: 'SELECT HOLIDAYS', agency: 'Adventure Travel', passenger: 'James Lee', hotel: 'Kalkan View Hotel', stars: 3, destination: 'Kalkan', checkIn: '2025-01-20', checkOut: '2025-01-24', nights: 4, room: 'Standard', board: 'Half Board', paxAdults: 2, paxChildren: 0, paxInfants: 0, status: 'CONFIRMED', voucherNo: 'SEL-2025-102' },
    { id: 'res-012', date: '23.01.2025', sourceAgency: 'AZURO', agency: 'Royal Tours', passenger: 'Patricia White', hotel: 'Göcek Luxury Resort', stars: 5, destination: 'Göcek', checkIn: '2025-01-23', checkOut: '2025-01-30', nights: 7, room: 'Villa', board: 'All Inclusive', paxAdults: 4, paxChildren: 3, paxInfants: 1, status: 'CONFIRMED', voucherNo: 'AZU-2025-267' },
    ...
    { id: 'res-014', date: '19.01.2025', sourceAgency: 'EURO TOURS', agency: 'Horizon Tours', passenger: 'Barbara Martin', hotel: 'Didim Sunset Hotel', stars: 4, destination: 'Didim', checkIn: '2025-01-19', checkOut: '2025-01-26', nights: 7, room: 'Deluxe', board: 'Full Board', paxAdults: 2, paxChildren: 0, paxInfants: 0, status: 'CONFIRMED', voucherNo: 'EUR-2025-178' },
    { id: 'res-015', date: '24.01.2025', sourceAgency: 'SELECT HOLIDAYS', agency: 'Prestige Travel', passenger: 'Daniel Thompson', hotel: 'Kemer Marina Resort', stars: 5, destination: 'Kemer', checkIn: '2025-01-24', checkOut: '2025-01-31', nights: 7, room: 'Suite', board: 'All Inclusive', paxAdults: 2, paxChildren: 0, paxInfants: 0, status: 'OPTION', voucherNo: 'SEL-2025-115' },
    { id: 'res-016', date: '21.01.2025', sourceAgency: 'AZURO', agency: 'Pearl Holidays', passenger: 'Nancy Martinez', hotel: 'Ölüdeniz Beach Hotel', stars: 4, destination: 'Ölüdeniz', checkIn: '2025-01-21', checkOut: '2025-01-28', nights: 7, room: 'Family Room', board: 'Half Board', paxAdults: 2, paxChildren: 3, paxInfants: 0, status: 'CONFIRMED', voucherNo: 'AZU-2025-278' },
    { id: 'res-017', date: '18.01.2025', sourceAgency: 'THV', agency: 'Diamond Tours', passenger: 'Paul Jackson', hotel: 'Dalyan Riverside Hotel', stars: 3, destination: 'Dalyan', checkIn: '2025-01-18', checkOut: '2025-01-22', nights: 4, room: 'Standard', board: 'Breakfast', paxAdults: 2, paxChildren: 0, paxInfants: 0, status: 'CONFIRMED', voucherNo: 'THV-2025-034' },
    ...
    { id: 'res-020', date: '22.01.2025', sourceAgency: 'AZURO', agency: 'Ruby Holidays', passenger: 'Betty Walker', hotel: 'Patara Beach Villa', stars: 5, destination: 'Patara', checkIn: '2025-01-22', checkOut: '2025-01-29', nights: 7, room: 'Villa', board: 'All Inclusive', paxAdults: 3, paxChildren: 2, paxInfants: 1, status: 'CONFIRMED', voucherNo: 'AZU-2025-289' },
  ];
