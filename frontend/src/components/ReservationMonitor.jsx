...
const ReservationMonitor = ({ isOpen, onClose }) => {
  ...
  const allReservations = [
    ...
    { date: '17.01.2025', agency: 'Dream Holidays', passenger: 'David Wilson', hotel: 'Marmaris Bay Hotel', stars: 3, destination: 'Marmaris', checkIn: '2025-01-17', checkOut: '2025-01-24', nights: 7, room: 'Standard', board: 'Full Board', paxAdults: 2, paxChildren: 0, paxInfants: 0, status: 'CANCELLED', note: 'Customer cancelled' },
    { date: '19.01.2025', agency: 'Paradise Tours', passenger: 'Lisa Anderson', hotel: 'Kaş Boutique Hotel', stars: 4, destination: 'Kaş', checkIn: '2025-01-19', checkOut: '2025-01-23', nights: 4, room: 'Deluxe', board: 'All Inclusive', paxAdults: 2, paxChildren: 1, paxInfants: 0, status: 'CONFIRMED', note: 'Honeymoon package' },
    { date: '21.01.2025', agency: 'Ocean View Travel', passenger: 'Robert Taylor', hotel: 'Çeşme Grand Resort', stars: 5, destination: 'Çeşme', checkIn: '2025-01-21', checkOut: '2025-01-28', nights: 7, room: 'Superior', board: 'Half Board', paxAdults: 2, paxChildren: 0, paxInfants: 0, status: 'OPTION', note: 'Waiting for confirmation' },
    { date: '16.01.2025', agency: 'Sunny Days Tours', passenger: 'Jennifer Martinez', hotel: 'Alanya Beach Club', stars: 4, destination: 'Alanya', checkIn: '2025-01-16', checkOut: '2025-01-30', nights: 14, room: 'Standard', board: 'All Inclusive', paxAdults: 2, paxChildren: 3, paxInfants: 1, status: 'CONFIRMED', note: 'Large family group' },
    { date: '22.01.2025', agency: 'Crystal Travel', passenger: 'William Garcia', hotel: 'Kuşadası Premium Hotel', stars: 5, destination: 'Kuşadası', checkIn: '2025-01-22', checkOut: '2025-01-26', nights: 4, room: 'Suite', board: 'Breakfast', paxAdults: 2, paxChildren: 0, paxInfants: 0, status: 'CONFIRMED', note: 'VIP treatment requested' },
    { date: '18.01.2025', agency: 'Elite Holidays', passenger: 'Mary Rodriguez', hotel: 'Side Star Resort', stars: 4, destination: 'Side', checkIn: '2025-01-18', checkOut: '2025-01-25', nights: 7, room: 'Deluxe', board: 'Full Board', paxAdults: 2, paxChildren: 2, paxInfants: 0, status: 'OPTION', note: 'Price negotiation pending' },
    { date: '20.01.2025', agency: 'Adventure Travel', passenger: 'James Lee', hotel: 'Kalkan View Hotel', stars: 3, destination: 'Kalkan', checkIn: '2025-01-20', checkOut: '2025-01-24', nights: 4, room: 'Standard', board: 'Half Board', paxAdults: 2, paxChildren: 0, paxInfants: 0, status: 'CONFIRMED', note: '' },
    { date: '23.01.2025', agency: 'Royal Tours', passenger: 'Patricia White', hotel: 'Göcek Luxury Resort', stars: 5, destination: 'Göcek', checkIn: '2025-01-23', checkOut: '2025-01-30', nights: 7, room: 'Villa', board: 'All Inclusive', paxAdults: 4, paxChildren: 3, paxInfants: 1, status: 'CONFIRMED', note: 'Corporate group booking' },
    { date: '17.01.2025', agency: 'Magic Travel', passenger: 'Christopher Harris', hotel: 'Belek Golf Resort', stars: 5, destination: 'Belek', checkIn: '2025-01-17', checkOut: '2025-01-21', nights: 4, room: 'Superior', board: 'All Inclusive', paxAdults: 2, paxChildren: 1, paxInfants: 0, status: 'CANCELLED', note: 'Medical reasons' },
    { date: '19.01.2025', agency: 'Horizon Tours', passenger: 'Barbara Martin', hotel: 'Didim Sunset Hotel', stars: 4, destination: 'Didim', checkIn: '2025-01-19', checkOut: '2025-01-26', nights: 7, room: 'Deluxe', board: 'Full Board', paxAdults: 2, paxChildren: 0, paxInfants: 0, status: 'CONFIRMED', note: 'Wheelchair accessible room' },
    { date: '24.01.2025', agency: 'Prestige Travel', passenger: 'Daniel Thompson', hotel: 'Kemer Marina Resort', stars: 5, destination: 'Kemer', checkIn: '2025-01-24', checkOut: '2025-01-31', nights: 7, room: 'Suite', board: 'All Inclusive', paxAdults: 2, paxChildren: 0, paxInfants: 0, status: 'OPTION', note: 'Payment pending' },
    { date: '21.01.2025', agency: 'Pearl Holidays', passenger: 'Nancy Martinez', hotel: 'Ölüdeniz Beach Hotel', stars: 4, destination: 'Ölüdeniz', checkIn: '2025-01-21', checkOut: '2025-01-28', nights: 7, room: 'Family Room', board: 'Half Board', paxAdults: 2, paxChildren: 3, paxInfants: 0, status: 'CONFIRMED', note: 'Kids club required' },
    { date: '18.01.2025', agency: 'Diamond Tours', passenger: 'Paul Jackson', hotel: 'Dalyan Riverside Hotel', stars: 3, destination: 'Dalyan', checkIn: '2025-01-18', checkOut: '2025-01-22', nights: 4, room: 'Standard', board: 'Breakfast', paxAdults: 2, paxChildren: 0, paxInfants: 0, status: 'CONFIRMED', note: '' },
    { date: '25.01.2025', agency: 'Sapphire Travel', passenger: 'Karen White', hotel: 'Turgutreis Spa Resort', stars: 5, destination: 'Turgutreis', checkIn: '2025-01-25', checkOut: '2025-02-01', nights: 7, room: 'Deluxe', board: 'All Inclusive', paxAdults: 2, paxChildren: 2, paxInfants: 0, status: 'CONFIRMED', note: 'Spa package included' },
    { date: '20.01.2025', agency: 'Emerald Tours', passenger: 'Mark Lewis', hotel: 'Çıralı Eco Resort', stars: 4, destination: 'Çıralı', checkIn: '2025-01-20', checkOut: '2025-01-27', nights: 7, room: 'Superior', board: 'Full Board', paxAdults: 2, paxChildren: 1, paxInfants: 0, status: 'OPTION', note: 'Upgrade consideration' },
    { date: '22.01.2025', agency: 'Ruby Holidays', passenger: 'Betty Walker', hotel: 'Patara Beach Villa', stars: 5, destination: 'Patara', checkIn: '2025-01-22', checkOut: '2025-01-29', nights: 7, room: 'Villa', board: 'All Inclusive', paxAdults: 3, paxChildren: 2, paxInfants: 1, status: 'CONFIRMED', note: 'Beach front villa' },
  ];
